...
public class PojoMapFactory {
	...
	public void setClasstree(List<String> classnames) {
		this.classtree = classnames;
	}
	...
	protected void initMaps() {
		log.debug("Initialize all maps, this should be done in advance, before any call");
		for (String classname : classtree) {
			try {
				Class<?> clazz = Class.forName(classname);
				Constructor<?> ctor = clazz.getConstructor();
				Object object = ctor.newInstance();
				createMapModel((AfEntity) object);
	...
	protected void createMapModel(conddb.data.AfEntity entity) throws ConddbWebException {
